...
def check_events(ai_settings, sb, screen, stats, play_button, ship, aliens, bullets):
...
def fire_bullet(ai_settings, screen, ship, bullets):
	"""Fire a bullet if limit not reached yer."""
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
	...
	# Draw the play button if the gmes is inactive.
...
def change_fleet_direction(ai_settings, aliens):
	"""Drop yhe entire fleet and change the fleet's direction"""
	for alien in aliens.sprites():
